...
**Logged**: 2026-06-21T20:00:00+08:00
**Priority**: high
**Status**: resolved
**Area**: docs

### Summary
“算法独立学习”必须区分 LeetCode 式通用算法与 Agent 求职所需的模型、检索和推理算法。

### Details
v1.2 将 Transformer、LoRA、SFT、DPO/GRPO 等模型基础也从 Agent 计划中删除，扩大了解释范围。用户实际只要求 LeetCode 中常见的数据结构与算法练习独立安排；模型基础和 Agent 算法仍应占用 Agent 每天 1 小时。

### Suggested Action
重命名文件以匹配当前周期和范围；只排除 LeetCode 式算法，重新加入模型基础、Post-Training 和 Agent 推理算法的逐日计划。

### Metadata
- Source: user_feedback
- Related Files: docs/05-roadmaps/personal-ai-agent-34-week-plan.md
- Tags: terminology, leetcode, model-algorithms, filename
- See Also: LRN-20260621-001, LRN-20260621-002

### Resolution
- **Resolved**: 2026-06-21T20:30:00+08:00
- **Commit/PR**: 0fcb1da3
- **Notes**: 文件已重命名，并扩展为 34 周；仅排除 LeetCode 式算法，恢复模型基础和 Agent 算法日程。
